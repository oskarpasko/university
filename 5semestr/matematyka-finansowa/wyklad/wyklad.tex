...
\section{Dyskonto przy wieloktrotnej kapitalizacji w ciągu roku}

Załóżmy że kapitalizaja odsetek odbywa się m-krotnie w ciągu roku (w równoległych odstępach czasu). Wówczas korzystając ze wzoru (16) obecną wartość $ PV(W) $ kwoty $ W $, którą mamy otrzymać w przyszłości po $ l $ latach i $ n $ spośród $ m $ podokresów $ l + 1  $ roku $ (0 <= n < m $ wyznaczamy wzór:
...
Przyjmując nominalną stopę procentową równą $ r = 6\% $ i zakładając  kapitalizację a) półroczną, b) miesięczną, c) dzienną, wzyanczyć obecną wartość kwoty 100 000 PLN, którą mamy otrzymać za 3 lata. W kazdym przypadku wyznaczyć wartość dyskonta
...
Przy założeniu miesięcznej kapitalizacji odsetek obecna wartość kwota 40 000 PLN, którą mamy otrzymać za 2 lata wynosci 36 500 PLN. Wyznaczyć wysokość nominalnej stopy procentowej.\\
...
\section{Dyskonto przy kapitalizacji ciągłes}
...
Zakładając ciągłą kapitalizację odsetek i orzyjmując roczną stopę procentową równą $ r = 5\%  $, wyznaczyć obecną wartość i dyskonto kwoty 50 000 PLN, którą mamy otrzymać za 3 lata i 5 miesięcy.\\
...
Nasze dotychczasowe rozważania dotyczyły dyskonta rzeczywistego, tzn. dyskonta opartego na stopie procentowej. Teraz omówimy dyskonto handlowe. Ograniczymy się przy tym jedynie do dyskonta handlowego prosteg, gdyż dyskonto handlowe składane na ogół nie jest wykorzystywane w praktyce. \\

\textbf{Dyskontem handlowym} nazywa sie opłatę za pożyczkę obliczoną na podstawie kwoty, którą dłużnik zwóci po ustalonym czasie, zapłaconą w chwili otrzymania pozyczki.\\
...
Zasada dyskonta prostego mówi, że dyskonto jest obliczane od kwoty, którą dłużnik zwróci po ustalonym czasie, jest proporcjonalne do tego czasu i jest odejmowane od tej kwoty w momencie udzielania pozyczki.\\

Jeżeli przez $ D $ oznaczymy sykonto, przez $ P $ początkową wartość pozyczki (tzn. wartość, którą fizycznie dostajemy), a przez $ F $ nominalna wartość pozyczki (to co mamy oddać, na kartce), to otrzymujemy równość:
...
gdzie $ n $ ozncza liczbę lat, po której ma nastąpić zwrot poożyczki.

\subsection{Przykład 24}
Wyznaczyć stopę dyskontową piżyczki w kwocie 50 000 PLn udzielonej na 5 lat, jeżeli jej wartośc nominalna wynosi 70 000 PLN.\\
...
Obliczyć nominalną wartośc 4-letniej pozyczki udzielonej w kwocie 100 000 PLN przy stopie dyskontowej równej $ 5\% $\\
...
Przy stopie dyskontowej równej $ r\% $ wyznaczyć poczatkową wartość dziesięcioletniej pozyczki o nominalnej wartości 200 000 PLN.\\
...
Pożyczka w wysokości 180 000 PLN udzielona na okres 5 lat ma nominalną wartość 240 000 PLN, Obliczyć stopę dyskontową i zbadać jaki wpływ na nominalną wartość pozyczki miałoby podniesienie stopy dyskontowej o 1 pkt procentowy.\\
...
Wzrost wartości stopy dyskontowej o 1 pkt procentowy spowodowałby wzrost nominalnej wartości pozyczki z 240 000 do 257 142,90.\\

\newpage

\section{Zasada równoważności stopy procentowej i stopy dyskontowej}
Zarówno odsetki jak i dyskonto stanowią opłatę za udzieloną pożyczkę. Czyli za możliowść dysponowania okreslonym kapitałem przez ostalony czas. Ponieważ walkosci te wyznacza się z różnych modeli naturalne wydaje się pytanie, jaki związek między nimi gwarantuje równość oĻlat za pożyczkę.\\

Roczna stopa procentowa $ r $ i stopa dyskontowa $ d $ nazywaja się \textbf{równoważnymi w czasie} $ n $ jeżeli dla dowolnej pozyczki odsetki i dyskonto handlowe wyznaczone przy tych stopach są równe. Tak sformułowana zasada nosi nazwę \textbf{zasady równoważności stopy procentowej i stopy dyskontowej}.
